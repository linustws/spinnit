...
def create_images(spinner_dimensions, spinner_center, spinner_radius, center_circle_radius):
    assets_rel_path = '../../assets/components/'
    # mask
    ...
    mask_img.save(assets_rel_path + 'mask.png')
    ...
    center_circle_mask_img.save(assets_rel_path + 'center_circle_mask.png')
    ...
    circle_outline_img.save(assets_rel_path + 'circle_outline.png')
    ...
    center_circle_outline_img.save(assets_rel_path + 'center_circle_outline.png')
    ...
    triangle_img.save(assets_rel_path + 'triangle.png')
